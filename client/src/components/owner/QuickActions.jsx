import { ChartColumn, Settings, UserPlus } from 'lucide-react';
import React from 'react';

const QuickActions = () => {
  return (
    <div className="flex flex-col justify-center bg-transparent border border-gray-800 mt-4 p-4 rounded-md">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-3 pt-5">
