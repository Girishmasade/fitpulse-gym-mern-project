  ...
  return (
    <div className='flex flex-col p-4 px-6 gap-5 bg-base-200 rounded-md'>
      <div className="flex flex-col">
        <h2 className='text-2xl font-semibold flex gap-2 items-center'><Apple className='colour'/>Nutrition Today</h2>
       ...
       <div className="text-center my-2">
         ...
         <div className="space-y-2">
          ...
          <button className="btn btn-outline btn-accent w-full flex gap-2" onClick={() => setOpen(!open)}>
            <Plus /> Log Meal
          </button>
        </div>
        <NutritionTodayCard open={open} setOpen={setOpen}/>
    </div>
  )
}
